...
# Suppress specific warnings related to deprecation
warnings.simplefilter("ignore", category=FutureWarning)

# Alternatively, you can use:
# Suppress all warnings from the torch library
...
model = torch.hub.load(
    './yolov5',  # Folder where the yolov5 repo is located
    'custom',
